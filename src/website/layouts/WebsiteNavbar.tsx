...
import MobileMenu from '../components/navigation/MobileMenu'; // Import the new component
    ...
    >
      <div className="relative z-50 max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
             ...
             {/* Mobile Menu Button */}
             <button className="md:hidden text-zinc-300 relative z-50" onClick={() => setIsMobileMenuOpen(true)}>
                <Menu />
             </button>
        </div>
      </div>
